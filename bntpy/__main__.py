...
parser = argparse.ArgumentParser(
    prog="Bayesian Network Tunning",
    description="Automatic Parameter Configuration")
parser.add_argument("-s",
                    "--scenario",
                    help="Path to scenario file (fomat file .toml)",
                    action="store",
                    type=str,
                    default=None)
parser.add_argument("-p",
                    "--parameters",
                    help="Path to paremeters file (fomat file .toml)",
                    action="store",
                    type=str,
                    required=True)
